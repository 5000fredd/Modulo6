<template>
    <div>
        ...
        <Modal v-model:modelValue="showModalEdit">
            <EditClienteView @on-update="onUpdate($event)" :item="itemToEdit" />
        </Modal>
...
import RegisterClienteView from './RegisterClienteView.vue'
import EditClienteView from './EditClienteView.vue'
...
export default {
    ...
    methods: {
        ...
        getList() {
            ...
            this.axios.get(this.baseUrl + "/clientes?q=" + this.textToSearch)
